...
namespace PhpLab\Database\Fixture\Repositories;
...
use PhpLab\Database\Db\Enums\DbDriverEnum;
use PhpLab\Database\Db\Base\BaseEloquentRepository;
use PhpLab\Database\Fixture\Entities\FixtureEntity;
...
class DbRepository extends BaseEloquentRepository
{
    ...
    public function __construct(\PhpLab\Database\Db\Helpers\Manager $capsule)
    {
