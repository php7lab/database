...
namespace PhpLab\Database\Migration\Commands;

use PhpLab\Database\Migration\Interfaces\Services\GenerateServiceInterface;
use PhpLab\Database\Migration\Scenarios\Input\ActionInputScenario;
use PhpLab\Database\Migration\Scenarios\Input\BaseInputScenario;
use PhpLab\Database\Migration\Scenarios\Input\DomainNamespaceInputScenario;
use PhpLab\Database\Migration\Scenarios\Input\TableNameInputScenario;
use PhpLab\Database\Migration\Scenarios\Input\TypeInputScenario;
