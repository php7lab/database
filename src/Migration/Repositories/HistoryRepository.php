...
namespace PhpLab\Database\Migration\Repositories;

use Illuminate\Database\Schema\Blueprint;
use PhpLab\Core\Legacy\Yii\Helpers\ArrayHelper;
use PhpLab\Database\Db\Base\BaseEloquentRepository;
use PhpLab\Database\Migration\Base\BaseCreateTableMigration;
use PhpLab\Database\Migration\Entities\MigrationEntity;
use PhpLab\Core\Helpers\ClassHelper;

//use PhpLab\Database\Db\Helpers\TableAliasHelper;
